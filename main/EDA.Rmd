...
```{r}
options(scipen = 99)
mod1 <- lm(reviews_per_month ~ bedrooms + availability_365 + review_scores_rating + 
             calculated_host_listings_count + minimum_nights + price, data = df_sub)
summary(mod1)
